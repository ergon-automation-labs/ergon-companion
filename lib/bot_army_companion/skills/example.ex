defmodule BotArmyCompanion.Skills.Example do
  @moduledoc """
  Example skill for Companion Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_companion.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_companion.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_companion/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_companion.command.example"
    ]
  end
